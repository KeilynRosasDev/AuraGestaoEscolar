// src/components/professor/DadosPessoaisProfessor.tsx
import React, { useState } from 'react';
import { Calendar, Mail, Phone, User, MapPin, Globe } from 'lucide-react';

interface DadosPessoaisProfessorProps {
  onSubmit: (dados: any) => void;
  initialData?: any;
}

const DadosPessoaisProfessor: React.FC<DadosPessoaisProfessorProps> = ({ 
  onSubmit, 
  initialData = {} 
}) => {
  const [formData, setFormData] = useState({
    ...
    reservista: initialData.reservista || '',
    ...
    <div className="p-8">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-between mt-10 pt-6 border-t border-gray-200">
          ...
          >
            Próxima Etapa: Dados Profissionais
          </button>
        </div>
      </form>
    </div>

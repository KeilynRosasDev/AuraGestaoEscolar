      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <button 
              onClick={() => console.log('Cadastrar Professor - Página em desenvolvimento')}
              className="px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg font-medium hover:shadow-md transition-all duration-300 flex items-center space-x-2 hover:scale-[1.02] active:scale-[0.98]"
            >
              <User size={16} />
